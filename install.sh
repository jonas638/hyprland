...
installDeps() {
    ...
    $ESCALATION_TOOL pacman -S --needed --noconfirm \
        cliphist waybar rofi grim slurp firefox brightnessctl hyprpicker hyprpaper bleachbit hyprland fastfetch cpio \
    ...
    $AUR_HELPER -S --needed --noconfirm \
        cava pipes.sh checkupdates-with-aur librewolf-bin waypaper-git hyprwall-bin wlogout \
